...
public class GraphEnterFrame extends JFrame
    ...
    public GraphEnterFrame(ParametersFrame parametersFrame_, Graph graph_) {
        ...
        btnAdd = new JButton("Add a vertex");
        ...
        btnDel = new JButton("Delete a vertex");
        ...
        btnAddEdge = new JButton("Add a edge");
        ...
        btnDelEdge = new JButton("Delete a edge");
    ...
    public void mouseClicked(MouseEvent e) {
        if(btnDelPressed) {
            ...
            infoLabel.setText("<html><p align=\"center\">Deleted vertex " + Graph.alphabet[count] + "</p><html>");
        ...
        if(btnAddEdgePressed) {
            ...
            if(btnConfirmPressed) {
                ...
                if (!check) {
                    infoLabel.setText("<html><p align=\"center\">Selected vertex "
                            + Graph.alphabet[count] + ".<br>Select a next vertex</p><html>");
                    dx = count;
                    check = true;
                } else {
                    boolean tmp = false;
                    ...
                    if(!tmp) {
                        infoLabel.setText("<html><p align=\"center\">Selected vertex " + Graph.alphabet[count]
                                + ".<br>Edge is creating " + Graph.alphabet[dx] + "-" + Graph.alphabet[count] + "</p><html>");
                        int free = 0;
                        for (int i = 0; i < counterEdgeMax; i++) {
                            if (edges[i] == null) {
                                free = i;
                        ...
                        if(dx == count)
                            infoLabel.setText("<html><p align=\"center\">Selected vertex "
                                    + Graph.alphabet[count] + ".<br>Action cancelled!</p><html>");
                        else
                            infoLabel.setText("<html><p align=\"center\">Selected vertex " + Graph.alphabet[count] + ".<br>Edge "
                                    + Graph.alphabet[dx] + "-" + Graph.alphabet[count] + " already exists!</p><html>");
                    }
        ...
        if (btnDelEdgePressed) {
            ...
            if(!check) {
                ...
                if(tmp)
                    infoLabel.setText("<html><p align=\"center\">Selected vertex " + Graph.alphabet[count] + ".<br>Deleted edge "
                            + Graph.alphabet[dx] + "-" + Graph.alphabet[count] + "</p><html>");
                else
                    infoLabel.setText("<html><p align=\"center\">This edge does not exist!</p><html>");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch(cmd) {
            case "AddVertexButton":
                ...
                infoLabel.setText("<html><p align=\"center\">Added vertex" + Graph.alphabet[free] + "</p><html>");
                setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
            ...
            case "DeleteVertexButton":
                ...
                infoLabel.setText("<html><p align=\"center\">Click on the vertex,<br>which you want to delete</p><html>");
            ...
            case "AddEdgeButton":
                ...
                infoLabel.setText("<html><p align=\"center\">Enter an edge weight<br>(from 1 to 100)</p><html>");
            ...
            case "DeleteEdgeButton":
                ...
                infoLabel.setText("<html><p align=\"center\">Click on 2 vertices,<br>which connect that edge</p><html>");
                setCursor(Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
            ...
            case "Confirm":
                try {
                    if (Integer.parseInt(weightTextField.getText()) <= 100
                        ...
                        infoLabel.setText("<html><p align=\"center\">Click on 2 vertices,<br>which you want to connect with an edge</p><html>");
                        setCursor(Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
                    }
